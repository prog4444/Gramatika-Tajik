...
@foreach ($main as $post)
    ...
    <h5 style="text-align: center; padding:2em; color:darkorange; font-size:20px;  ">{{ $post->title }}</h5>
    <div class="text-p" style="background-color:aliceblue ">{!!$post->description!!}</div>
